...
//		bool WriteImage(wxImage *dest, const wxColour &colour=*wxBLACK, double factor=1.0, double dx=0.0, double dy=0.);
		...
		static inline int CompareOrder(Entity2D ***p_e1, Entity2D ***p_e2) { return CompareOrder((Line2D***)p_e1, (Line2D***)p_e2); };
		static int CompareOrder(Line2D *** p_line1, Line2D *** p_line2);
